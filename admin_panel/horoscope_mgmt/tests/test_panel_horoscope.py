...
class HoroscopePanelPoruthamPayloadTests(TestCase):
    ...
    def test_panel_porutham_includes_bride_groom_horoscope_and_grahanila(self):
        ...
        self.assertIn("kujadhosham", result)
        self.assertIn("papam_samyam", result)
        self.assertIn("papam_samaytam", result)
        self.assertIn("dasa_sandhi", result)
        self.assertIn("kuja_dosham_bride", result["flags"])
        self.assertIn("kuja_dosham_groom", result["flags"])
        self.assertIn("papam_samyam_matched", result["flags"])
        self.assertIn("dasa_sandhi", result["flags"])
