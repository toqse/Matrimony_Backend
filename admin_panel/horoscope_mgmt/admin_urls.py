...
from .views import (
    ...
    AdminHoroscopePanelGeneralSelectionGroupsView,
    AdminHoroscopePanelGeneralSelectionsView,
    AdminHoroscopePanelSavedPoruthamGroupsView,
...
urlpatterns = [
    ...
    path("porutham/saved/groups/", AdminHoroscopePanelSavedPoruthamGroupsView.as_view(), name="admin_horoscope_porutham_saved_groups"),
    path("porutham/saved/", AdminHoroscopePanelSavedPoruthamView.as_view(), name="admin_horoscope_porutham_saved"),
    path("selections/groups/", AdminHoroscopePanelGeneralSelectionGroupsView.as_view(), name="admin_horoscope_selections_groups"),
    path("selections/", AdminHoroscopePanelGeneralSelectionsView.as_view(), name="admin_horoscope_selections"),
