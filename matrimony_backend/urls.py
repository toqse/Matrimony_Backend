...
from core.health import HealthCheckView, HealthLiveView
...
from admin_panel.testimonials.views import PublicTestimonialListAPIView
...
from admin_panel.branches.views import PublicBranchListAPIView
...
urlpatterns = [
    ...
    path('api/v1/admin/horoscope/', include('admin_panel.horoscope_mgmt.admin_urls')),
    path('api/v1/staff/horoscope/', include('admin_panel.horoscope_mgmt.staff_urls')),
    path('api/v1/branch/horoscope/', include('admin_panel.horoscope_mgmt.branch_urls')),
    ...
    path('api/v1/admin/profile-reports/', include('profile_reports.admin_urls')),
    ...
    path('api/v1/profile-reports/', include('profile_reports.urls')),
    ...
    path('api/v1/website/testimonials/', PublicTestimonialListAPIView.as_view()),
    ...
    path('api/v1/website/branches/', PublicBranchListAPIView.as_view()),
    path('api/v1/website/enquiries/', PublicEnquiryCreateAPIView.as_view()),
