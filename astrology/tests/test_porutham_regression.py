...
from astrology.services.nakshatra_data import NAKSHATRA_MAP, NAKSHATRA_YONI
...
VERIFIED_PAIRS = [
    ...
    {
        "label": "Anupriya(Vishakha/Tula) vs Abhinav(Krittika/Mesha) 2026-04-22",
        "bride": {"nakshatra": "Vishakha", "rasi": "Tula"},
    ...
    {
        "label": "Vaishnava(Chitra/Kanya) vs Abhinav(Krittika/Mesha) 2026-04-22",
...
class PoruthamRegressionTests(unittest.TestCase):
    ...
    def test_dhanishta_ardra_koota_spotcheck(self):
        ...
        self.assertEqual(sthree_deergha_points("Dhanishta", "Ardra"), 0.5)
    ...
    def test_dina_verify_block(self):
        ...
        self.assertEqual(dina_points("Bharani", "Dhanishta"), 1.0)
    ...
    def test_gana_verify_block(self):
        ...
        self.assertEqual(
            gana_points(
                gana_for_nakshatra("Chitra"),
                gana_for_nakshatra("Krittika"),
            ),
            1.0,
        )

    def test_sthree_deergha_verify_block(self):
        self.assertEqual(sthree_deergha_points("Vishakha", "Ardra"), 0.5)
        self.assertEqual(sthree_deergha_points("Dhanishta", "Chitra"), 1.0)
        self.assertEqual(sthree_deergha_points("Chitra", "Krittika"), 0.5)
        ...
        self.assertEqual(sthree_deergha_points("Ashwini", "Magha"), 0.5)
    ...
    def test_yoni_verify_block(self):
        ...
        self.assertEqual(yoni_points("Rohini", "Uttara Ashadha"), 0.5)
    ...
    def test_rasi_verify_block(self):
        ...
        self.assertEqual(rasi_points("Mesha", "Meena"), 1.0)
        self.assertEqual(rasi_points("Vrishabha", "Mesha"), 1.0)
        self.assertEqual(rasi_points("Simha", "Karka"), 1.0)
        self.assertEqual(rasi_points("Mesha", "Vrishabha"), 0.0)
        self.assertEqual(rasi_points("Vrishabha", "Vrischika"), 1.0)
        self.assertEqual(rasi_points("Makara", "Makara"), 1.0)
        # (bride - groom) % 12 == 1 → adjacent sign pair Vrischika/Tula after Vishakha→Vrischika primary.
        self.assertEqual(rasi_points("Vrischika", "Tula"), 1.0)
    ...
    def test_vasya_verify_block(self):
        ...
        self.assertEqual(vasya_points("Dhanus", "Meena"), 1.0)
        self.assertEqual(vasya_points("Mesha", "Mithuna"), 0.0)
        self.assertEqual(vasya_points("Kanya", "Vrischika"), 1.0)
        self.assertEqual(vasya_points("Vrishabha", "Vrischika"), 1.0)
        self.assertEqual(vasya_points("Kumbha", "Dhanus"), 0.0)
    ...
    def test_rasyadhipathi_verify_block(self):
        ...
        self.assertEqual(rasyadhipathi_points("Tula", "Mithuna"), 1.0)
        self.assertEqual(rasyadhipathi_points("Kanya", "Mesha"), 1.0)
        self.assertEqual(rasyadhipathi_points("Mesha", "Simha"), 0.0)
        self.assertEqual(rasyadhipathi_points("Karka", "Simha"), 0.0)
        self.assertEqual(rasyadhipathi_points("Mesha", "Karka"), 0.0)
        self.assertEqual(rasyadhipathi_points("Mesha", "Mesha"), 1.0)
        self.assertEqual(rasyadhipathi_points("Kanya", "Mithuna"), 1.0)
        self.assertEqual(rasyadhipathi_points("Vrishabha", "Makara"), 1.0)
        self.assertEqual(rasyadhipathi_points("Mithuna", "Simha"), 1.0)
        self.assertEqual(rasyadhipathi_points("Kanya", "Makara"), 1.0)
        self.assertEqual(rasyadhipathi_points("Dhanus", "Vrischika"), 1.0)
        self.assertEqual(rasyadhipathi_points("Mithuna", "Karka"), 0.0)
        self.assertEqual(rasyadhipathi_points("Simha", "Mesha"), 0.0)
    ...
    def test_rajju_kati_and_sira_dosha_pairs(self):
        ...
        self.assertEqual(rajju_points("Purva Ashadha", "Uttara Bhadrapada"), 0.0)
    ...
    def test_vedha_verify_block(self):
        ...
        self.assertEqual(vedha_points("Ardra", "Hasta"), 1.0)
        self.assertEqual(vedha_points("Shravana", "Shatabhisha"), 1.0)
        self.assertEqual(vedha_points("Mula", "Revati"), 1.0)
        self.assertEqual(vedha_points("Ashwini", "Bharani"), 1.0)
        self.assertEqual(len(_VEDHA_PAIRS), 6)
